...
console.log(array1)//전체 배열 출력(테스트용 전체정상확인,및 인덱스번호확인)
console.log(array1[0])//개별 배열 직접출력(이벤트,속성,메서드 / 동적결과 제작)
console.log(array1[1])//개별 배열 직접출력
console.log(array1[2])//개별 배열 직접출력
//DOM 변수 생성
const li = document.querySelectorAll('ul li') //두개 이상
...
//const product_color = ['red','blue','green']
